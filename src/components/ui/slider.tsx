...
function Landing() {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden bg-navy text-ivory">
      {/* SLIDESHOW BACKGROUND — Slide Horizontal */}
      ...
      {/* MOBILE HOST — อยู่หน้าสุด สไลด์จากด้านขวา */}
      <motion.img
        ...
        className="lg:hidden fixed -right-[15%] bottom-0 h-[75vh] max-h-[650px] w-auto object-contain object-bottom pointer-events-none drop-shadow-[0_30px_60px_rgba(0,0,0,0.5)] z-50"
      />
