...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Goodfill Care — Wellness Journey  Samui" },
      { name: "description", content: "Goodfill  Care   Wellness  Samui" },
      { name: "theme-color", content: "#FFF8EC" },
      { property: "og:title", content: "Goodfill Care — Wellness Journey  Samui" },
      ...
      { name: "google-site-verification", content: "UNPWGVjT5m4JslinX6nZtPGEejd5UMk6de9Hf0nCeqc" },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/d51d90c2-8bc0-46d1-8ff1-4e4e5690a80b",
      },
      {
        name: "twitter:image",
        content:
