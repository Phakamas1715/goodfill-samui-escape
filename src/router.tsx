        ...
        >
          <div className="flex items-center justify-between gap-2">
            ...
            <button
              onClick={runAI}
              disabled={loadingAI}
              className="btn-gold rounded-full px-4 py-2 text-xs md:text-sm font-bold inline-flex items-center gap-1.5 disabled:opacity-60 shadow-[0_0_24px_rgba(244,166,74,0.55)] ring-1 ring-gold/60"
            >
